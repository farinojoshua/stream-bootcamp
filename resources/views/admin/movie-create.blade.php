      ...
      <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.store') }}">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" value="{{ old('title') }}" name="title" placeholder="e.g Guardian of The Galaxy">
          </div>
          <div class="form-group">
            <label for="trailer">Trailer</label>
            <input type="text" class="form-control" id="trailer" value="{{ old('trailer') }}" name="trailer" placeholder="Video url">
          </div>
          <div class="form-group">
            <label for="movie">Movie</label>
            <input type="text" class="form-control" id="movie" value="{{ old('movie') }}" name="movie" placeholder="Video url">
          </div>
          <div class="form-group">
            <label for="duration">Duration</label>
            <input type="text" class="form-control" id="duration" value="{{ old('duration') }}" name="duration" placeholder="1h 39m">
          </div>
          <div class="form-group">
            <label>Date:</label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="short-about" value="{{ old('short-about') }}" name="short_about" placeholder="Awesome Movie">
          </div>
          <div class="form-group">
            <label for="about">About</label>
            <input type="text" class="form-control" id="about" value="{{ old('about') }}" name="about" placeholder="Awesome Movie">
          </div>
          <div class="form-group">
